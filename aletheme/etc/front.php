...
/**
 * Custom Css
 * Данный фрагмент кода добовляется когда в админке в пункте Внешний вид - Theme Options - 
 * Advanced Settings
 * в окне Custom CSS Styles 
 * вставляется какой то стиль.
 */
function ale_customcss(){
	// лежит general.php 988
	// вызывает get_template_part('partials/' . $slug, $name);
	// запускает файл в partials/css-option
    ale_part('css-option');
